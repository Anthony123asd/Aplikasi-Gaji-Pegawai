...
<body>
    ...
    <div>
        <h1 style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">Aplikasi Penghitung Gaji Pegawai</h1>
        <table>
            <tr>
                <td>Nama Pegawai</td>
                <td>:</td>
                <td><asp:TextBox ID="txtNamaPegawai" runat="server" ></asp:TextBox></td>
                <td><asp:RequiredFieldValidator ID="rfvNamaPegawai" runat="server" ErrorMessage="Nama tidak boleh kosong" ControlToValidate="txtNamaPegawai" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>Golongan</td>
                ...
                <td><asp:RequiredFieldValidator ID="rfvGolongan" runat="server" ErrorMessage="Golongan harus dipilih" ControlToValidate="lbGolongan" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>Jenis Kelamin</td>
                ...
                <td><asp:RequiredFieldValidator ID="rfvJenisKelamin" runat="server" ErrorMessage="Jenis kelamin harus diisi" ControlToValidate="rblJenisKelamin" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>Jenis Pegawai</td>
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <asp:RadioButtonList ID="rblStatusMenikah" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rblStatusMenikah_SelectedIndexChanged">
            ...
            <tr>
                <td>
                    <asp:Button ID="btnHitung" runat="server" Text="Hitung" 
                        onclick="btnHitung_Click" style="height: 26px"/>
                </td>
